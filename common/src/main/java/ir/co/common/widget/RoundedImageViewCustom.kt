...
// https://github.com/rishabh876/RoundedImageView  > version: 0.8.4

class RoundedImageViewCustom : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundedImageViewCustom, 0, 0)
        val cornerRadius =
            a.getDimensionPixelSize(R.styleable.RoundedImageViewCustom_cornerRadius, 0)
        val roundedCorners =
            a.getInt(R.styleable.RoundedImageViewCustom_roundedCorners, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundedImageViewCustom_reverseMask, reverseMask)
        placeHolder = a.getInt(R.styleable.RoundedImageViewCustom_placeHolder, 0)
        val loadUrl = a.getString(R.styleable.RoundedImageViewCustom_load)
        a.recycle()
        init()
    ...
    constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int) : super(
        ...
        val a = getContext().obtainStyledAttributes(
            attrs,
            R.styleable.RoundedImageViewCustom,
            defStyleAttr,
            0
        )
        val cornerRadius =
